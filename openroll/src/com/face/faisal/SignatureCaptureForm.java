 ...
 * @author Faisal
 */
public class SignatureCaptureForm extends JFrame implements Runnable, WebcamPanel.Painter  
{
...
//        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
    ...
    private void onCapture(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_onCapture
        try
        {
            ...
            ApplicationNidPanel.lbl_signature.setText(null);    
            ApplicationNidPanel.lbl_signature.setIcon(new ImageIcon(webcam.getImage().getScaledInstance(ApplicationNidPanel.lbl_signature.getWidth(),ApplicationNidPanel.lbl_signature.getHeight(),java.awt.Image.SCALE_DEFAULT)));

            ////main.applicationData.setSignature(ImageAndFileProcessing.BufferedImageToByteArray(webcam.getImage(),"BMP"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignatureCaptureForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignatureCaptureForm().setVisible(true);
            }
        });
    }
